...
import { AppExpandTableComponent } from './call-journal/expand-table.component';
import{AppExpandTableComponentSms} from './sms/expand-table.component';
...
export const AppsRoutes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'sms-journal',
        component: AppExpandTableComponentSms,
        data: {
          title: 'SMS-journal',
          urls: [
            { title: 'Dashboard', url: '/dashboards/dashboard1' },
