...
export class AppJournalComponent implements OnInit {
  ...
  openDialog(action: string, obj: any): void {
    obj.action = action;
    const dialogRef = this.dialog.open(AppJournalDialogContentComponent, {
      data: obj,
    });
...
@Component({
  ...
  templateUrl: 'journal-dialog-content.html',
})
// tslint:disable-next-line - Disables all
export class AppJournalDialogContentComponent {
  action: string;
  // tslint:disable-next-line - Disables all
  local_data: any;

  constructor(
    public dialogRef: MatDialogRef<AppJournalDialogContentComponent>,
